...
<div class="form-popup" id="myForm">
  <form action="automatizovana_akcija.php" class="form-container" method="GET">
    <?php if(sizeof($barcode) > 0){ 
?>
    Barcode: <?php echo $barkod11 ?>
    Procenat: <?php echo $procenat11 ?>

    <input type="hidden" name="barkod" value="<?php echo $barkod11 ?>">
    <input type="hidden" name="cena" value="<?php echo $cena11 ?>">
    <input type="hidden" name="procenat" value="<?php echo $procenat11 ?>">
    <input type="hidden" name="radnja" value="<?php echo $radnja11 ?>"> <?php }
    else{
