...
<body id="LoginForm">
	...
	<form id="form1" action="dodaj1.php" method="POST">
        <select name="Tip" onchange = "submitForm()">
...
<?php
	...
	<form action="dodaj2.php" method="POST" id="tekst">
		...
		Bar kod:
		<input type = "text" name = "proizvod_barcode" id="tekst2"><br>
		Naziv:
		...
		Cena:
		<input type = "text" name = "cena" id="tekst2"><br>
		Kolicina:
		<input type = "text" name = "kolicina" id="tekst2"><br>
		...
		if($select == "eksterni_disk"){ ?>
			...
			<select name="format_eksterni_disk" id="tekst2">
				<option value="" selected disabled hidden>Izaberi format</option>
		...
		if($select == "kablovi"){ ?>
			...
			<select name="vrsta_kablovi" id="tekst2">
				<option value="" selected disabled hidden>Izaberi vrstu</option>
		...
		if($select == "mis"){ ?>
			...
			<select name="rezolucija_mis" id="tekst2">
				<option value="" selected disabled hidden>Izaberi rezoluciju</option>
			...
			<select name="povezivanje_mis" id="tekst2">
				<option value="" selected disabled hidden>Izaberi povezivanje</option>
			...
			<select name="senzor_mis" id="tekst2">
				<option value="" selected disabled hidden>Izaberi senzor</option>
		...
		if($select == "monitor"){ ?>
			...
			<select name="usb_monitor" id="tekst2">
				<option value="" selected disabled hidden>Izaberi USB</option>
			...
			<select name="hdmi_monitor" id="tekst2">
				<option value="" selected disabled hidden>Izaberi HDMI</option>
				<option value="1">1</option>
 				<option value="2">2</option>
  				<option value="3">3</option>
		...
		if($select == "podloga"){ ?>
			...
			<select name="materijal_podloga" id="tekst2">
				<option value="" selected disabled hidden>Izaberi materijal</option>
		...
		if($select == "slusalice"){ ?>
			...
			<select name="mikrofon_slusalice" id="tekst2">
				<option value="" selected disabled hidden>Izaberi mikrofon</option>
				<option value="Ne">Ne</option>
			...
			<select name="zvucni_sistem_slusalice" id="tekst2">
				<option value="" selected disabled hidden>Izaberi zvucni sistem</option>
		...
		if($select == "tastatura"){ ?>
			...
			<select name="tip_tastera_tastatura" id="tekst2">
				<option value="" selected disabled hidden>Izaberi tip tastera</option>
