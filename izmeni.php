...
if(isset($_POST["izmeni"])){
	...
	$sql = "UPDATE proizvodi SET Naziv ='" .$naziv. "', Model = '" .$model. "', Dimenzije = '" .$dimenzije. "', Proizvodjac = '" .$proizvodjac. "', Cena = '" .$cena. "', Kolicina = '" .$kolicina. "', Duzina_garantnog_lista = '" .$duzina_gar_lista. "', Link = '" .$link. "', Slika = '" .$slika. "' WHERE Barcode = '" .$barcode. "'";
	...
	if($tip == "tastatura"){
		...
		$sql = "UPDATE tastatura SET Povezivanje ='" .$povezivanje. "', USB_port = '" .$usb_ports. "', Numericki_deo = '" .$numericki_deo. "', Tip_tastatura = '" .$tip. "', Tip_tastera = '" .$tip_tastera. "', Programabilni_tasteri = '" .$programabilni_tasteri. "', RGB_osvetljenje = '" .$rgb_osvetljenje. "' WHERE Barcode = '" .$barcode. "'";
		$veza->query($sql) or die($veza->error);
	}
